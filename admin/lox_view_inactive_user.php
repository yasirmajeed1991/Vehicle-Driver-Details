...
$query	=	"SELECT users.id,users.name,users.email,users.username,category.cat_name,
		...
		{			$i=$i+1;
					$html	.=	'<tr style="font-size:12px">
								...
								<td >'.$row['mobile'].'</td>
								<td >'.$row['cityname'].'</td>
								<td><a href="functions.php?user_delete='.$row['id'].'"><i class="fa fa-minus-square icon-white"></i></a> &nbsp <a  href="functions.php?user_active='.$row['id'].'"><i class="fa fa-check"></i></a></td>
								</tr>	  ';
